...
<Note>
  Contact [sales](https://bipa.tech) if you need higher limits.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Use events API">
    Instead of polling for status changes, use the [Events API](/api-reference/partner/events/overview) to track state changes efficiently.
  </Accordion>
...
Track your API usage in the [console](https://console.bipa.tech):
