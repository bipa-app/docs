...
// Create a customer
const customer = await fetch("https://api.bipa.tech/v1/customers", {
  method: "POST",
  headers,
  body: JSON.stringify({
    type: "individual",
...
const quote = await fetch(
  "https://api.bipa.tech/v1/quotes?from=BRL&to=USDT&amount_cents=100000",
  { headers }
).then(r => r.json());
...
<CardGroup cols={2}>
  ...
  <Card title="Pix Payments" icon="bolt" href="/api-reference/pix/overview">
    Accept and send instant Pix payments.
  </Card>
