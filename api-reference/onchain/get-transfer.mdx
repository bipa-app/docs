...
For pending transfers, you can poll the status or use webhooks:
...
<Tip>
  Using webhooks is more efficient than polling. Subscribe to `onchain.transfer.confirmed` events.
</Tip>
